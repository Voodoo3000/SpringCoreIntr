...
import com.epam.jmp.bean.B;
import com.epam.jmp.bean.F;
...
public class App {
    public static void main(String[] args) {
        ConfigurableApplicationContext ctx = new ClassPathXmlApplicationContext("service.xml", "bean.xml");
        /*
...
*/
        B bClass = ctx.getBean(B.class);
        bClass.methodForEClass();
